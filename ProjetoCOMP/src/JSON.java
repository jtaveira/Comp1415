...
public class JSON/*@bgen(jjtree)*/implements JSONTreeConstants, JSONConstants {static /*@bgen(jjtree)*/

	boolean sintaticError = false;
...
protected static JJTJSONState jjtree = new JJTJSONState();public static void main(String args[]) throws ParseException, IOException {
	...
	while(op!=3){
		...
		if(op==1){
			System.out.println("Insira o código desejado:");
...
final public SimpleNode Expression() throws ParseException {
	...
	if(sintaticError)
		System.out.println("Input lido com erros sintáticos.\n");

	else
		System.out.println("Input lido sem erros sintáticos.\n");
